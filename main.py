...
"""
        ...
        if not _cerrar_desde_armando and resp_llm.tool_calls:
            ...
            if si_respuesta_directa:
                ...
                # Detectar si alguna tool quedó con ambigüedad pendiente
                # (devolvió "varias opciones") — bug real: cliente pide
                # "hamburguesa, Juana y agua", entran solo los productos
                # claros y los ambiguos se pierden sin avisar. Reunimos
                # esas preguntas para no perderlas.
                pendientes_ambiguos = [
                ...
                if pendientes_ambiguos:
                    # Adjuntamos las preguntas de desambiguación pendientes.
                    # Limpiamos el encabezado repetido si hay más de una.
                    if len(pendientes_ambiguos) == 1:
                        ...
                        for p in pendientes_ambiguos:
                            # Quitar el encabezado generico, dejar solo las opciones
